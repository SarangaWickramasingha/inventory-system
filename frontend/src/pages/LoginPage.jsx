      ...
      <div className="fixed inset-0 bg-slate-950/65 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
        ...
        <div className="w-full max-w-md my-auto bg-white/10 backdrop-blur-2xl py-8 px-6 shadow-2xl rounded-3xl border border-white/20 sm:px-10 text-white relative">
          ...
          <div className="mt-6 pt-6 border-t border-white/15">
            <p className="text-center text-[10px] font-extrabold text-slate-300 uppercase tracking-wider mb-3">
              Quick Demo Access
            </p>
            <div className="grid grid-cols-2 gap-2.5">
              <button
                ...
                className="py-2 px-3 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl border border-white/15 transition-all"
              >
                Demo Admin
              </button>
              <button
                ...
                className="py-2 px-3 bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 text-xs font-bold rounded-xl border border-blue-400/30 transition-all"
              >
                Demo Staff
              </button>
            </div>
